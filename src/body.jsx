...
const Body = () => {
  ...
  const handleVideoCallOption = () => {
    // Redirect to Calendify for scheduling a video call
      ...
      <main style={styles.main}>
        <section style={styles.searchSection}>
          ...
          <div style={styles.optionsSection}>
            <button style={styles.button} onClick={handleFormOption}>Send Details via Form</button>
            <button style={styles.button} onClick={handleVideoCallOption}>Schedule a Video Call</button>
          </div>
        </section>
